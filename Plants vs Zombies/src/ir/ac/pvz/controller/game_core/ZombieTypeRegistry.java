...
public final class ZombieTypeRegistry {
    ...
    private void registerDefaults(StageConfig stageConfig) {
        ...
        register("PeashooterZombie", PeashooterZombie::new);
        register("WallnutZombie", WallnutZombie::new);
        register("JalapenoZombie", JalapenoZombie::new);
        register("SquashZombie", SquashZombie::new);
