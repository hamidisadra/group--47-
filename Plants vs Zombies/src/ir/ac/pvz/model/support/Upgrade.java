...
public class Upgrade {
    ...
    private void applyCategoryUpgrade(Plant plant, String type) {
        if (level == 2 && type.equals("cactus") && plant instanceof StrikeThroughPlant) {
            ...
            reduceRecharge(plant, type.equals("squash") ? 3f : 2f);
    ...
    private static boolean addUpgradeGroupOne(Plant p, String type) {
        switch (type) {
            case "sunflower": addUpgrades(p, 0,0,0, 0,150,0, 0,0,0); return true;
            case "twinsunflower": addUpgrades(p, 0,0,0, 0,150,0, 0,0,25); return true;
            case "sunshroom": addUpgrades(p, 0,0,0, 0,150,0, 0,0,0); return true;
            case "primalsunflower": addUpgrades(p, 0,0,0, 0,150,0, 0,0,25); return true;
            case "goldbloom": addUpgrades(p, 0,0,0, 0,0,0, 0,0,25); return true;
            case "peashooter": addUpgrades(p, 10,0,0, 0,150,0, 0,0,25); return true;
            case "repeater": addUpgrades(p, 10,0,0, 0,200,0, 0,0,25); return true;
            case "threepeater": addUpgrades(p, 0,0,25, 10,0,0, 0,200,0); return true;
            case "snowpea": addUpgrades(p, 10,0,0, 0,0,0, 0,0,25); return true;
            case "rotobaga": addUpgrades(p, 10,0,0, 0,150,0, 0,0,25); return true;
            case "peapod": addUpgrades(p, 10,0,0, 0,200,0, 0,0,25); return true;
            case "splitpea": addUpgrades(p, 10,0,0, 0,200,0, 0,0,25); return true;
            case "citron": addUpgrades(p, 0,0,0, 150,0,0, 0,0,50); return true;
            case "caulipower": addUpgrades(p, 0,0,0, 0,150,0, 0,0,50); return true;
            case "electricblueberry": addUpgrades(p, 0,0,0, 0,0,0, 0,0,25); return true;
            case "bowlingbulb": addUpgrades(p, 0,0,0, 15,0,0, 0,0,25); return true;
            case "cactus": addUpgrades(p, 0,0,0, 10,0,0, 0,0,25); return true;
            case "firepeashooter": addUpgrades(p, 10,0,0, 0,200,0, 0,0,25); return true;
    ...
    private static boolean addUpgradeGroupTwo(Plant p, String type) {
        switch (type) {
            case "starfruit": addUpgrades(p, 0,0,0, 10,0,0, 0,0,25); return true;
            case "goopeashooter": addUpgrades(p, 0,0,0, 0,150,0, 0,0,25); return true;
            case "megagatlingpea": addUpgrades(p, 10,0,0, 0,0,0, 0,0,50); return true;
            case "seashroom": addUpgrades(p, 0,0,0, 5,0,0, 0,0,0); return true;
            case "puffshroom": addUpgrades(p, 0,0,0, 10,0,0, 0,0,0); return true;
            case "fumeshroom": addUpgrades(p, 0,0,0, 10,0,0, 0,0,25); return true;
            case "cabbagepult": addUpgrades(p, 10,0,0, 0,0,0, 0,150,0); return true;
            case "kernelpult": addUpgrades(p, 0,0,0, 10,0,0, 0,150,0); return true;
            case "melonpult": addUpgrades(p, 0,0,25, 0,0,0, 30,0,0); return true;
            case "wintermelon": addUpgrades(p, 0,0,50, 0,0,0, 0,0,25); return true;
            case "pepperpult": addUpgrades(p, 15,0,0, 0,0,0, 0,0,25); return true;
            case "potatomine": addUpgrades(p, 0,0,0, 0,0,0, 600,0,0); return true;
            case "primalpotatomine": addUpgrades(p, 0,0,0, 0,0,0, 400,0,0); return true;
            case "cherrybomb": addUpgrades(p, 0,0,0, 600,0,0, 0,0,25); return true;
            case "squash": addUpgrades(p, 0,0,0, 600,0,0, 0,0,0); return true;
            case "grapeshot": addUpgrades(p, 600,0,0, 0,0,0, 0,0,25); return true;
            case "jalapeno": addUpgrades(p, 0,0,0, 600,0,0, 0,0,25); return true;
            case "doomshroom": addUpgrades(p, 0,0,0, 800,0,0, 0,0,50); return true;
            default: return false;
        }
    }
    ...
    private static boolean addUpgradeGroupThree(Plant p, String type) {
        switch (type) {
            case "tanglekelp": addUpgrades(p, 0,0,0, 0,0,0, 0,0,25); return true;
            case "iceberglettuce": addUpgrades(p, 0,0,0, 0,0,0, 0,0,0); return true;
            case "bonkchoy": addUpgrades(p, 5,0,0, 0,0,0, 0,200,0); return true;
            case "phatbeet": addUpgrades(p, 10,0,0, 0,0,0, 0,200,0); return true;
            case "chomper": addUpgrades(p, 0,0,0, 0,200,0, 0,0,0); return true;
            case "wasabiwhip": addUpgrades(p, 10,0,0, 0,0,0, 0,200,0); return true;
            case "kiwibeast": addUpgrades(p, 0,200,0, 15,0,0, 0,0,0); return true;
            case "wallnut": addUpgrades(p, 0,1000,0, 0,0,0, 0,1500,0); return true;
            case "tallnut": addUpgrades(p, 0,2000,0, 0,0,0, 0,3000,0); return true;
            case "endurian": addUpgrades(p, 0,0,0, 0,1000,0, 0,0,25); return true;
            case "garlic": addUpgrades(p, 0,150,0, 0,0,0, 0,250,0); return true;
            case "sweetpotato": addUpgrades(p, 0,1000,0, 0,0,0, 0,1500,0); return true;
            case "explodeonut": addUpgrades(p, 0,1000,0, 0,0,0, 0,0,25); return true;
            case "pumpkin": addUpgrades(p, 0,1000,0, 0,0,0, 0,1500,0); return true;
            case "sunbean": addUpgrades(p, 0,0,0, 0,150,0, 0,0,25); return true;
            case "torchwood": addUpgrades(p, 0,300,0, 0,0,0, 0,0,25); return true;
            case "magnetshroom": addUpgrades(p, 0,0,0, 0,0,0, 0,200,0); return true;
            case "hypnoshroom": addUpgrades(p, 0,0,25, 0,0,0, 0,0,0); return true;
            default: return false;
        }
    }
    ...
    private static void addUpgradeGroupFour(Plant p, String type) {
        switch (type) {
            case "cattail": addUpgrades(p, 10,0,0, 0,200,0, 0,0,25); break;
            case "imitater": addUpgrades(p, 0,0,0, 0,0,25, 0,0,0); break;
            case "iceshroom": addUpgrades(p, 0,0,0, 0,0,0, 50,0,0); break;
            case "lilypad": addUpgrades(p, 0,0,25, 0,200,0, 0,0,0); break;
            case "hotpotato": case "gravebuster":
                addUpgrades(p, 0,0,0, 0,0,0, 0,0,0); break;
            case "enlightenmint": case "appeasemint": case "armamint":
            case "bombardmint": case "enforcemint": case "reinforcemint":
            case "enchantmint": case "piercemint": case "cattailmint":
                addUpgrades(p, 0,0,0, 0,0,0, 0,0,0); break;
            default: break;
        }
    }
